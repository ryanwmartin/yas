...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post visitors_url, params: { visitor: { first_name: @visitor.first_name, last_name: @visitor.last_name, middle_name: @visitor.middle_name } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { first_name: @visitor.first_name, last_name: @visitor.last_name, middle_name: @visitor.middle_name } }
